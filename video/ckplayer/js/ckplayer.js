     ...
     function ckplayerEmbed(videoObj) {
         ...
         var into = function(obj) {
             ...
             loadFace = function() {
                 ...
                 C['rightBar']['smallwindows']['open'].click(function() { tip(this, language['smallwindowsClose'], null, 'left');
                 ...
                 C['rightBar']['smallwindows']['close'].click(function() { tip(this, language['smallwindowsOpen'], null, 'left');
                 ...
                 C['rightBar']['loop']['open'].click(function() { tip(this, language['loopClose'], null, 'left');
                     player.loop(false); });
                 ...
                 C['rightBar']['loop']['close'].click(function() { tip(this, language['loopOpen'], null, 'left');
                     player.loop(true); });
